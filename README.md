...
[docs-badge]: https://docs.rs/elfo/0.2.0-alpha.9/elfo
[docs-url]: https://docs.rs/elfo/0.2.0-alpha.9/elfo
...
```toml
[dependencies]
elfo = { version = "0.2.0-alpha.9", features = ["full"] }

[dev-dependencies]
elfo = { version = "0.2.0-alpha.9", features = ["test-util"] }
```
